...
HD_PWD='D:/D_Strabi/D_Dokumentumai/BME/MikrorendszerekTevezese/HF/K-gy-j-t-k/ddr3_dma/ddr3_dma.runs/cpu_system_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_system_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_system_axi_gpio_0_0.tcl
