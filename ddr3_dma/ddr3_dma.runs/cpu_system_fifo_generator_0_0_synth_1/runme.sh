...
EAStep vivado -log cpu_system_fifo_generator_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_system_fifo_generator_0_0.tcl
