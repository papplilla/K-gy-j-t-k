...
HD_PWD='D:/D_Strabi/D_Dokumentumai/BME/MikrorendszerekTevezese/HF/K-gy-j-t-k/ddr3_dma/ddr3_dma.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cpu_system_wrapper.tcl -notrace
