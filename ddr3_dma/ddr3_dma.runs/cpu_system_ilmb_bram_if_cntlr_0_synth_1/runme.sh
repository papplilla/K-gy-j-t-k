...
HD_PWD='F:/Egyetem/mikrorendszerek/ddr3_dma/ddr3_dma.runs/cpu_system_ilmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_system_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_system_ilmb_bram_if_cntlr_0.tcl
